...
const OrderDrawer = ({selectedOrder, closeDrawer, isAnimating}) => {
  const { formatTimestamp, statusHandler } = useContext(ShopContext)
  ...
  >
    <div
      className={`bg-white w-full sm:w-96 p-6 shadow-2xl transform overflow-y-scroll transition-transform duration-300 
            ...
            <div className="gap-5 text-sm">
              ...
              <div className='grid grid-cols-2 gap-4 text-sm'>
                <div>
                  ...
                  <p className="text-gray-800 font-semibold">PKR {selectedOrder.amount || 9000}</p>
                </div>
                <div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-gray-800">{selectedOrder.address.firstName}</p>
              </div>
              <div>
              ...
              <tbody>
                {selectedOrder.items?.map((item, index) => (
                  <tr key={index} className="border-t">
                    ...
                    <td className="py-2 px-4">PKR {item.price}</td>
                  </tr>
                ))}
              </tbody>
            </table>
