...
function SignupEmail() { 
  ...
  return (
      <div className=" flex items-center flex-col justify-center  rounded-lg py-12 w-full">
        <h2 className="text-2xl font-semibold text-center uppercase text-[#333] mb-6">
          Join Our Community
        </h2>
        ...
        <form onSubmit={onSubmitHandler} className="flex gap-2" >
                ...
                <button type="submit" className="bg-gradient-to-r from-[#cba135] to-[#cba035b3] border-none text-[#fff] rounded-sm py-2 px-4 font-semibold text-md shadow-sm">SignUp</button>
        </form>
